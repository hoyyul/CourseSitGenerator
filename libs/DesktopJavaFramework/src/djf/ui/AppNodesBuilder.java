...
public class AppNodesBuilder {
    ...
    public Tab buildTab(String style, Object tabId){
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        String propName = tabId.toString() + "_TEXT";
        String tabText = props.getProperty(propName);
        Tab tab= new Tab();
        if (tabText != null) {
