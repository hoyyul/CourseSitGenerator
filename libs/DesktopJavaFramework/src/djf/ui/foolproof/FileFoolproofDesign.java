...
public class FileFoolproofDesign implements FoolproofDesign {
    ...
    public void updateControls() {
        ...
        enableIfInUse(HAS_CLOSE,    CLOSE_BUTTON,   !((Button)app.getGUIModule().getGUINode(SAVE_BUTTON)).isDisable());
        enableIfInUse(HAS_EXPORT,   EXPORT_BUTTON,  app.getFileModule().canExport());
