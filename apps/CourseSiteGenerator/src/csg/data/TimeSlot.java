...
public class TimeSlot {
    ...
    private HashMap<DayOfWeek, ArrayList<LectureData>> lectures;
    ...
    public TimeSlot(String initStartTime, String initEndTime) {
        ...
        for (DayOfWeek dow : DayOfWeek.values()) {
            ...
            lectures.put(dow, new ArrayList());
    ...
    public void addLecture(DayOfWeek dow, LectureData lecture) {
        ArrayList<LectureData> lectureList = lectures.get(dow);
    ...
    public void removeLecture(DayOfWeek dow, LectureData lecture) {
        ArrayList<LectureData> LectureDataList = lectures.get(dow);
        if (LectureDataList.contains(lecture)) {
            LectureDataList.remove(lecture);
            updateDayText(dow);
        }
    }
    ...
    public void toggleLecture(DayOfWeek dow, LectureData lecture) {
        ArrayList<LectureData> lectureList = lectures.get(dow);
        if (lectureList.contains(lecture)) {
            removeLecture(dow, lecture);
        } else {
            addLecture(dow, lecture);
        }
    }
